...
Function SendMail(Subject, Sender, Recipient, Body)
			  ...
			  strFrom = ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "mailSender")  
			...
			With Flds
				...
				.Item("http://schemas.microsoft.com/cdo/configuration/smtpserverport")= ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "porta") 
				.Item("http://schemas.microsoft.com/cdo/configuration/smtpserver") = ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "smtp") 
				.Item("http://schemas.microsoft.com/cdo/configuration/smtpconnectiontimeout") = ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "timeout") 
				if ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "perfil")=1 then
					.Item("http://schemas.microsoft.com/cdo/configuration/smtpauthenticate")= 1
					.Item("http://schemas.microsoft.com/cdo/configuration/sendusername") = ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "utilizador") 
					.Item ("http://schemas.microsoft.com/cdo/configuration/sendpassword") = ReadIniFile(Server.MapPath("/rbcatalogo/cgi/cgi.ini"), "MAIL", "senha") 
				end if
				.Update
			End With
	...
	Select Case componente							'Application(ScriptName & "UploadComponent")
		...
		Case "ASPSmartUpload"
            ...
            case "iso"
				   ...
				   savepath= "/rbcatalogo/upload/isos/"
			case "img"
				   AllowedFilesList = "jpg,gif,png"
				   savepath= "/rbcatalogo/upload/fotos/leitores/"
...
Function GenerateTagCloud(arrAllTags, flag)
  ...
  strUrlPrefix = strROOT & "/cgi/www.exe/[in=pesqger.in]?base=rbcatalogo&formato=wiusr&nut="+session("nuser")+"&ut="+us+"&id=3&nomemnu=catpesq.asp&bd=col&lim_inicio=1&limites=25&expressao=PCH "
