...
'Jun 28, 2018: Valida ficheiros autorizados por extensão (from bui_trung_hieu )
...
Class FreeASPUpload
  ...
  keys = UploadedFiles.keys
  items = UploadedFiles.items
 ' For Each fileItem In UploadedFiles.Items
  For i = 0 to UploadedFiles.Count -1
  	SET fileItem = items(i)
 
'Check valid extensions
    if ValidFileExtension(fileItem.FileName, "ISO;TXT") then
...
Private Function GetFileExtension(strFileName)
...
Private Function ValidFileExtension(strFileName, strFileExtensions)
