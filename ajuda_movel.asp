...
<body>
	...
	<div id="principal">
		...
		<h2><img src="imagens/pictitulos/pic_ajuda_alt.svg" alt="Utilizar o catálogo coletivo em telemóveis" title="Utilizar o catálogo coletivo em telemóveis" height="70" width="70" style="vertical-align:middle" /><br />Como utilizar o catálogo em telemóveis?</h2>
		<div class="col1-contentor" style="width:100%">
			<div class="col1" style="min-width:50%;background-color:#f9f9ed;">
				<h3><img src="imagens/pictitulos/pic_movel_alt.svg" alt="Utilização em telemóveis" title="Utilização em telemóveis" height="50" width="50" style="vertical-align:middle" />No navegador Web e sem aplicações</h3>
				<p>Pode utilizar o catálogo no telemóvel com o seu navegador Web habitual, basta entrar no endereço do catálogo.
					...
					<br /><span style="text-align:center; display: block;"><img src="imagens/ajuda/movel_entrada.png" alt="Catálogo no telemóvel" title="Catálogo no telemóvel"/></span>
			...
			<div class="col1" style="min-width:50%">
				...
				<p>No seu telemóvel, abra a aplicação de QR Code e aponte a câmara para esta imagem:
					<br />
					<br />
					<span style="text-align:center; display: block;"><img src="imagens/app/qrcode.png" alt="Ligação em QR Code para o catálogo" title="Ligação em QR Code para o catálogo"/></span>
					<br />
		...
		<div class="col1-contentor" style="width:100%">
			<div class="col1" style="min-width:60%">
				<h3><img src="imagens/pictitulos/pic_ecran_app_alt.svg" alt="Acesso direto no ecrã" title="Acesso direto no ecrã" height="50" width="50" style="vertical-align:middle" />Atalho no ecrã principal (tipo aplicação)</h3>
			...
			<div class="col1" style="min-width:40%">
					<img src="imagens/ajuda/movel_adicionar.png" alt="Menu do navegador Web" title="Adicionar ao ecrã principal do telemóvel" align="center"/>
			</div>
		</div>
		<br style="clear:left" />
		<div class="destaquetexto1">
			<h4 align="left"><img src="imagens/pictitulos/pic_questao_alt.svg" alt="Dúvidas" title="Dúvidas" height="22" width="22" style="vertical-align:middle" />Dúvidas sobre utilização em telemóveis?</h4>
